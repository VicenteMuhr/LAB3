...
public class Main {
    ...
    //para evitar confusiones.
        ...
        // Opciones de algoritmos y atributos
        String[] algorithms = {"bubbleSort", "insertionSort", "selectionSort", "mergeSort", "quickSort", "countingSort", "Collections.sort"};
        ...
        // Selección de Atributo de Ordenamiento
            ...
            switch (chosenAttribute) {
                case "price":
                    ...
                    if (!foundByPrice.isEmpty()) {
                        foundByPrice.forEach(game -> System.out.println("  " + game.getName() + " (Precio: " + game.getPrice() + ")"));
                    } else {
                ...
                case "category":
                    ...
                    if (!foundByCategory.isEmpty()) {
                        foundByCategory.forEach(game -> System.out.println("  " + game.getName() + " (Categoría: " + game.getCategory() + ")"));
                    } else {
                ...
                case "quality":
                    ...
                    if (!foundByQuality.isEmpty()) {
                        foundByQuality.forEach(game -> System.out.println("  " + game.getName() + " (Calidad: " + game.getQuality() + ")"));
                    } else {
                        System.out.println("  No se encontraron juegos con esa calidad.");
                    }
                    break;
                default:
                    System.out.println("No se puede realizar una búsqueda específica para el atributo '" + chosenAttribute + "'.");
                    break;
            }
        }
