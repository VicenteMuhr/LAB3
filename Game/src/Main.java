...
/*
        GenerateData.saveGamesToCsv(GenerateData.generateRandomGames(100),
                "games_dataset_100.csv");
        GenerateData.saveGamesToCsv(GenerateData.generateRandomGames(10000),
                "games_dataset_10000.csv");
        GenerateData.saveGamesToCsv(GenerateData.generateRandomGames(1000000),
